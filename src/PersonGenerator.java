...
public class PersonGenerator
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            firstName = SafeInput.getNonZeroLenString(s, "Enter your First Name");
            lastName = SafeInput.getNonZeroLenString(s, "Enter your Last Name");
            title = SafeInput.getNonZeroLenString(s, "Enter your Title");
